                        ...
                        <form @submit.prevent="openConfirmModal">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input v-model.trim="form.custFirstName" type="text" class="form-control"
                                        maxlength="100" required />
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Last Name</label>
                                    <input v-model.trim="form.custLastName" type="text" class="form-control"
                                        maxlength="100" required />
                                </div>

                                <div class="col-12">
                                    <label class="form-label">Email Address</label>
                                    <input v-model.trim="form.orderEmail" type="email" class="form-control"
                                        maxlength="255" required />
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Phone Number</label>
                                    <input v-model.trim="form.orderPhone" type="text" class="form-control"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" @click="closeConfirmModal"
                            :disabled="submitting">
                            Cancel
                        </button>
